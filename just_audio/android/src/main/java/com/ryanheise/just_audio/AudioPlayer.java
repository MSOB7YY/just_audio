  ...
  private Map<String, Object> equalizerAudioEffectGetParameters() {
    ...
    for (short i = 0; i < equalizer.getNumberOfBands(); i++) {
      rawBands.add(mapOf("index", i, "lowerFrequency", (double) equalizer.getBandFreqRange(i)[0] / 1000.0,
          ...
          (double) equalizer.getCenterFreq(i) / 1000.0, "gain", equalizer.getBandLevel(i) / 100.0));
    }
    return mapOf("parameters", mapOf("minDecibels", equalizer.getBandLevelRange()[0] / 100.0, "maxDecibels",
        equalizer.getBandLevelRange()[1] / 100.0, "bands", rawBands));
  }
